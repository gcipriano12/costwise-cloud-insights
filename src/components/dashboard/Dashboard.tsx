...
export default function Dashboard() {
  ...
  const costEventsData = [
    ...
    { id: 'e1', date: '2025-04-20', title: 'Faturamento AWS (anterior)', type: 'billing' as const, impact: 543210.50, currency: 'R$' },
    { id: 'e2', date: '2025-05-02', title: 'Renovação licenças (anterior)', type: 'contract' as const, impact: 85000.00, currency: 'R$' },
    
    // Eventos do mês atual
    { id: 'e3', date: '2025-05-20', title: 'Faturamento AWS', type: 'billing' as const, impact: 543210.50, currency: 'R$' },
    { id: 'e4', date: '2025-05-25', title: 'Renovação contrato Azure', type: 'contract' as const, impact: 120000.00, currency: 'R$' },
    { id: 'e5', date: '2025-05-28', title: 'Revisão de orçamento', type: 'budget' as const },
    
    // Eventos futuros
    { id: 'e6', date: '2025-06-05', title: 'Faturamento GCP', type: 'billing' as const, impact: 234567.40, currency: 'R$' },
    { id: 'e7', date: '2025-06-15', title: 'Renovação suporte', type: 'contract' as const, impact: 75000.00, currency: 'R$' },
  ];
